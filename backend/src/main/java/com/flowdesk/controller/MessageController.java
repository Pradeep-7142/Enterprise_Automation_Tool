...
public class MessageController {
    ...
    @GetMapping({"/messages/conversations", "/conversations"})
    ...
    @GetMapping({"/messages/conversations/{id}", "/conversations/{id}"})
    ...
    @PostMapping({"/messages/conversations/{id}", "/conversations/{id}"})
    ...
    @PostMapping({"/messages/conversations/direct/{employeeId}", "/conversations/direct/{employeeId}"})
